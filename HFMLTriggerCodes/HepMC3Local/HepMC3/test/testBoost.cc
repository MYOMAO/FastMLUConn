...
int main()
{
    ...
    GenParticlePtr p1 = std::make_shared<GenParticle>( FourVector2(1.0,1.0,7000,7000),2212, 3 );
    evt.add_particle( p1 );
    ...
    evt.add_vertex( v2 );
    GenParticlePtr p2 = std::make_shared<GenParticle>(  FourVector2(1.0,1.0,-7000,7000),2212, 3 );
    evt.add_particle( p2 );
    ...
    GenParticlePtr p3 = std::make_shared<GenParticle>( FourVector2(.750,-1.569,32.191,32.238),1, 3 );
    evt.add_particle( p3 );
    ...
    GenParticlePtr p4 = std::make_shared<GenParticle>( FourVector2(-3.047,-19.,-54.629,57.920),-2, 3 );
    evt.add_particle( p4 );
    ...
    GenParticlePtr p6 = std::make_shared<GenParticle>(  FourVector2(-3.813,0.113,-1.833,4.233 ),22, 1 );
    evt.add_particle( p6 );
    ...
    GenParticlePtr p5 = std::make_shared<GenParticle>( FourVector2(1.517,-20.68,-20.605,85.925),-24, 3 );
    evt.add_particle( p5 );
    ...
    //
    // create v4
    GenVertexPtr v4 = std::make_shared<GenVertex>(FourVector2(0.12,-0.3,0.05,0.004));
    evt.add_vertex( v4 );
    v4->add_particle_in( p5 );
    GenParticlePtr p7(new GenParticle( FourVector2(-2.445,28.816,6.082,29.552), 1,1 ));
    evt.add_particle( p7 );
    v4->add_particle_out( p7 );
    GenParticlePtr p8(new GenParticle( FourVector2(3.962,-49.498,-26.687,56.373), -2,1 ));
    evt.add_particle( p8 );
    ...
    FourVector2 b(0.1,0.3,-0.2,0);
    FourVector2 bp(-0.1,-0.3,0.2,0);
    evt.boost(b);
    for ( GenParticlePtr ip: evt.particles()) {
        Print::line(ip,true);
    }
