...
int main()
{
    ...
    evt.add_vertex( v1 );
    GenParticlePtr p1 = std::make_shared<GenParticle>( FourVector2(0,0,7000,7000),2212, 3 );
    ...
    evt.add_vertex( v2 );
    GenParticlePtr p2 = std::make_shared<GenParticle>(  FourVector2(0,0,-7000,7000),2212, 3 );
    ...
    GenParticlePtr ploop = std::make_shared<GenParticle>(  FourVector2(0.0,0.0,0.0,0.0 ),21, 3 );
