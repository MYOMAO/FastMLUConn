...
//
// -- Purpose: Test that an event can be written to a binary stream and then
// read by the protobufIO reader
//
...
int main() {
    ...
    evt.set_units(HepMC3::Units2::MEV, HepMC3::Units2::CM);
    ...
    auto writer = std::make_shared<HepMC3::Writerprotobuf>(binstream, gri);
