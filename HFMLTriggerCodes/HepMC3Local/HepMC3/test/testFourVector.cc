...
int main()
{
    std::vector<FourVector2>  vectors_to_test{
        FourVector2(0.0, 0.0, 0.0, 0.0),
        FourVector2(1.0, 2.0, 0.0, 0.0),
        FourVector2(0.0, 0.0, 0.0, 1.0),
        FourVector2(0.0, 0.0, 0.0,-1.0),
        FourVector2(0.0, 0.0, 1.0, 0.0),
        FourVector2(0.0, 0.0,-1.0, 0.0),
        FourVector2(1.0, 2.0, 3.0, 4.0),
        FourVector2(1.0, 2.0, 3.0, -4.0),
        FourVector2(1.0, 2.0, -3.0, 4.0),
        FourVector2(1.0, 2.0, -3.0, -4.0),
        FourVector2(1.0, 2.0, -3.0, 40.0),
        FourVector2(1.0, 2.0, -3.0, -40.0)
    };
