...
public:
    ...
    static MomentumUnit momentum_unit( const std::string& name ) {
        ...
        HEPMC3_ERROR("Units2::momentum_unit: unrecognised unit name: '" << name <<"', setting to GEV" )
    ...
    static LengthUnit length_unit( const std::string& name ) {
        ...
        HEPMC3_ERROR("Units2::length_unit: unrecognised unit name: '" << name <<"', setting to CM" )
    ...
    /** @brief Convert FourVector2 to different momentum unit */
    template <typename T>
    ...
    /** @brief Convert FourVector2 to different length unit */
    template <typename T>
