...
public:
    ...
    GenParticle( const FourVector2 &momentum = FourVector2::ZERO_VECTOR(), int pid = 0, int status = 0 );
...
public:
    ...
    const FourVector2& momentum()  const { return m_data.momentum;       } //!< Get momentum
    ...
    void set_momentum(const FourVector2& momentum); //!< Set momentum
