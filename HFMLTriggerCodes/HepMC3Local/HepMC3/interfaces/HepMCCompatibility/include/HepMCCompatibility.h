...
{
    std::cout << "Now Using" << std::endl;
    HepMC3::GenEvent* n=new HepMC3::GenEvent();
    HepMC3::Units2::LengthUnit lu;
    HepMC3::Units2::MomentumUnit mu;
    if (evt.length_unit()==HepMC3::Units2::CM) lu=HepMC3::Units2::CM;
    if (evt.length_unit()==HepMC3::Units2::MM) lu=HepMC3::Units2::MM;
    if (evt.momentum_unit()==HepMC3::Units2::MEV) mu=HepMC3::Units2::MEV;
    if (evt.momentum_unit()==HepMC3::Units2::GEV) mu=HepMC3::Units2::GEV;
    n->set_units(mu,lu);
