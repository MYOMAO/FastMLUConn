...
GenVertex::GenVertex(const FourVector2& pos):
    m_event(nullptr),
    m_id(0) {
    m_data.status   = 0;
    m_data.position = pos;
...
const FourVector2& GenVertex::position() const {
    ...
    return FourVector2::ZERO_VECTOR();
}

void GenVertex::set_position(const FourVector2& new_pos) {
