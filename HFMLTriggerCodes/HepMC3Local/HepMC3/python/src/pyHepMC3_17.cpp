...
void bind_pyHepMC3_17(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // HepMC3::HEPEUPAttribute file:HepMC3/LHEFAttributes.h line:68
		...
		cl.def("momentum", (class HepMC3::FourVector2 (HepMC3::HEPEUPAttribute::*)(int) const) &HepMC3::HEPEUPAttribute::momentum, "Get momentum \n\nC++: HepMC3::HEPEUPAttribute::momentum(int) const --> class HepMC3::FourVector2", pybind11::arg("i"));
