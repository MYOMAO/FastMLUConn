...
void custom_Units_binder(pybind11::class_<HepMC3::Units2, std::shared_ptr<HepMC3::Units2>> cl)
{
		//cl.def_static("convert",  []( auto & a1, enum HepMC3::Units2::MomentumUnit a2, enum HepMC3::Units2::MomentumUnit a3)-> void { HepMC3::Units2::convert<decltype(a1)>(a1,a2,a3); }, "C++: HepMC3::Units2::convert(class HepMC3::FourVector2 &, enum HepMC3::Units2::MomentumUnit, enum HepMC3::Units2::MomentumUnit) --> void", pybind11::arg("m"), pybind11::arg("from"), pybind11::arg("to"));
		//cl.def_static("convert", []( auto & a1, enum HepMC3::Units2::LengthUnit a2, enum HepMC3::Units2::LengthUnit a3)-> void { HepMC3::Units2::convert<decltype(a1)>(a1,a2,a3); }, "C++: HepMC3::Units2::convert(class HepMC3::FourVector2 &, enum HepMC3::Units2::MomentumUnit, enum HepMC3::Units2::MomentumUnit) --> void", pybind11::arg("m"), pybind11::arg("from"), pybind11::arg("to"));

		cl.def_static("convert",  [](HepMC3::FourVector2 & a1, enum HepMC3::Units2::MomentumUnit a2, enum HepMC3::Units2::MomentumUnit a3)-> void { HepMC3::Units2::convert<HepMC3::FourVector2>(a1,a2,a3); }, "C++: HepMC3::Units2::convert(class HepMC3::FourVector2 &, enum HepMC3::Units2::MomentumUnit, enum HepMC3::Units2::MomentumUnit) --> void", pybind11::arg("m"), pybind11::arg("from"), pybind11::arg("to"));
		cl.def_static("convert", []( HepMC3::FourVector2 & a1, enum HepMC3::Units2::LengthUnit a2, enum HepMC3::Units2::LengthUnit a3)-> void { HepMC3::Units2::convert<HepMC3::FourVector2>(a1,a2,a3); }, "C++: HepMC3::Units2::convert(class HepMC3::FourVector2 &, enum HepMC3::Units2::MomentumUnit, enum HepMC3::Units2::MomentumUnit) --> void", pybind11::arg("m"), pybind11::arg("from"), pybind11::arg("to"));
}


void custom_FourVector_binder(pybind11::class_<HepMC3::FourVector2, std::shared_ptr<HepMC3::FourVector2>> cl)
{
		cl.def("__getitem__", [](const HepMC3::FourVector2& v, size_t i) { if (i==0) return  v.x(); if (i==1) return  v.y(); if (i==2) return  v.z();  if (i==3) return  v.t(); return 0.0;});
		cl.def("__setitem__", [](HepMC3::FourVector2& v, size_t i, double  a ) { if (i==0)   { v.setX(a); return; }if (i==1)  { v.setY(a);return; } if (i==2)  { v.setZ(a);return; }  if (i==3) {v.setT(a);return; }});
		cl.def("__len__", [](const HepMC3::FourVector2& /*v*/) { return 4;});
...
void	print_binder(pybind11::module &M)
	...
	{ // HepMC3::Print file: line:27
		...
		//cl.def_static("line", (void (*)(std::ostream &, const class HepMC3::FourVector2 &)) &HepMC3::Print::line, "Print one-line info\n\nC++: HepMC3::Print::line(std::ostream &, const class HepMC3::FourVector2 &) --> void", pybind11::arg("os"), pybind11::arg("p"));
		cl.def_static("line", [](pybind11::object  & a0, const class HepMC3::FourVector2 & a1) -> void {  std::stringstream b; HepMC3::Print::line(b, a1);   a0.attr("write")(pybind11::str(b.str().c_str()));  }, "Print one-line info\n\nC++: HepMC3::Print::line(std::ostream &, const class HepMC3::FourVector2 &) --> void", pybind11::arg("os"), pybind11::arg("p"));
		cl.def_static("line", (void (*)(const class HepMC3::FourVector2 &)) &HepMC3::Print::line, "Print one-line info to std::cout\n\nC++: HepMC3::Print::line(const class HepMC3::FourVector2 &) --> void", pybind11::arg("p"));
