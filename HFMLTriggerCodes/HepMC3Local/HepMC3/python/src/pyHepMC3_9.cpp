...
void bind_pyHepMC3_9(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // HepMC3::GenParticle file:HepMC3/GenParticle.h line:31
		...
		cl.def( pybind11::init( [](const class HepMC3::FourVector2 & a0){ return new HepMC3::GenParticle(a0); } ), "doc" , pybind11::arg("momentum"));
		cl.def( pybind11::init( [](const class HepMC3::FourVector2 & a0, int const & a1){ return new HepMC3::GenParticle(a0, a1); } ), "doc" , pybind11::arg("momentum"), pybind11::arg("pid"));
		cl.def( pybind11::init<const class HepMC3::FourVector2 &, int, int>(), pybind11::arg("momentum"), pybind11::arg("pid"), pybind11::arg("status") );
		...
		cl.def("momentum", (const class HepMC3::FourVector2 & (HepMC3::GenParticle::*)() const) &HepMC3::GenParticle::momentum, "C++: HepMC3::GenParticle::momentum() const --> const class HepMC3::FourVector2 &", pybind11::return_value_policy::automatic);
		...
		cl.def("set_momentum", (void (HepMC3::GenParticle::*)(const class HepMC3::FourVector2 &)) &HepMC3::GenParticle::set_momentum, "C++: HepMC3::GenParticle::set_momentum(const class HepMC3::FourVector2 &) --> void", pybind11::arg("momentum"));
	...
	{ // HepMC3::GenVertex file:HepMC3/GenVertex.h line:26
		...
		cl.def( pybind11::init<const class HepMC3::FourVector2 &>(), pybind11::arg("position") );
		...
		cl.def("position", (const class HepMC3::FourVector2 & (HepMC3::GenVertex::*)() const) &HepMC3::GenVertex::position, "Get vertex position\n\n Returns the position of this vertex. If a position is not set on _this_ vertex,\n the production vertices of ancestors are searched to find the inherited position.\n FourVector2(0,0,0,0) is returned if no position information is found.\n\nC++: HepMC3::GenVertex::position() const --> const class HepMC3::FourVector2 &", pybind11::return_value_policy::automatic);
		...
		cl.def("set_position", (void (HepMC3::GenVertex::*)(const class HepMC3::FourVector2 &)) &HepMC3::GenVertex::set_position, "Set vertex position\n\nC++: HepMC3::GenVertex::set_position(const class HepMC3::FourVector2 &) --> void", pybind11::arg("new_pos"));
