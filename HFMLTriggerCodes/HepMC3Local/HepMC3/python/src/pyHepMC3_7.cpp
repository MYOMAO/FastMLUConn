...
void bind_pyHepMC3_7(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // HepMC3::Units file: line:26
		pybind11::class_<HepMC3::Units2, std::shared_ptr<HepMC3::Units2>> cl(M("HepMC3"), "Units", "");
		cl.def( pybind11::init( [](){ return new HepMC3::Units2(); } ) );

		pybind11::enum_<HepMC3::Units2::MomentumUnit>(cl, "MomentumUnit", pybind11::arithmetic(), "Momentum units ")
			.value("MEV", HepMC3::Units2::MEV)
			.value("GEV", HepMC3::Units2::GEV)
			.export_values();


		pybind11::enum_<HepMC3::Units2::LengthUnit>(cl, "LengthUnit", pybind11::arithmetic(), "Position units ")
			.value("MM", HepMC3::Units2::MM)
			.value("CM", HepMC3::Units2::CM)
			.export_values();

		cl.def_static("momentum_unit", (enum HepMC3::Units2::MomentumUnit (*)(const std::string &)) &HepMC3::Units2::momentum_unit, "Get momentum unit based on its name\n\nC++: HepMC3::Units2::momentum_unit(const std::string &) --> enum HepMC3::Units2::MomentumUnit", pybind11::arg("name"));
		cl.def_static("length_unit", (enum HepMC3::Units2::LengthUnit (*)(const std::string &)) &HepMC3::Units2::length_unit, "Get length unit based on its name\n\nC++: HepMC3::Units2::length_unit(const std::string &) --> enum HepMC3::Units2::LengthUnit", pybind11::arg("name"));
		cl.def_static("name", (std::string (*)(enum HepMC3::Units2::MomentumUnit)) &HepMC3::Units2::name, "Get name of momentum unit \n\nC++: HepMC3::Units2::name(enum HepMC3::Units2::MomentumUnit) --> std::string", pybind11::arg("u"));
		cl.def_static("name", (std::string (*)(enum HepMC3::Units2::LengthUnit)) &HepMC3::Units2::name, "Get name of length unit \n\nC++: HepMC3::Units2::name(enum HepMC3::Units2::LengthUnit) --> std::string", pybind11::arg("u"));
