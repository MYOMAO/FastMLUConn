...
int main() {
    ...
    GenParticlePtr p3 = std::make_shared<GenParticle>( FourVector2( 0.0,    0.0,  -7000.0,  7000.0  ),2212,  3 );
    GenParticlePtr p4 = std::make_shared<GenParticle>( FourVector2(-3.047,-19.0,    -54.629,  57.920),  -2,  3 );
    ...
    GenParticlePtr p5 = std::make_shared<GenParticle>( FourVector2(-3.813,  0.113, -1.833, 4.233),  22, 1 );
    GenParticlePtr p6 = std::make_shared<GenParticle>( FourVector2( 1.517,-20.68, -20.605,85.925), -24, 3 );
    ...
    GenParticlePtr p7 = std::make_shared<GenParticle>( FourVector2(-2.445, 28.816,  6.082,29.552),  1, 1 );
    GenParticlePtr p8 = std::make_shared<GenParticle>( FourVector2( 3.962,-49.498,-26.687,56.373), -2, 1 );
...
*/
    ...
    evt.shift_position_by( FourVector2(5,5,5,5) );
