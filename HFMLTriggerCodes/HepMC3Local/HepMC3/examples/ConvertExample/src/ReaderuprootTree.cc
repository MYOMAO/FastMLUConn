...
bool ReaderuprootTree::read_event(GenEvent& evt)
{
    ...
    m_event_data->momentum_unit = momentum_unit == 0?HepMC3::Units2::MEV:HepMC3::Units2::GEV;
    m_event_data->length_unit = length_unit == 0?HepMC3::Units2::MM:HepMC3::Units2::CM;
