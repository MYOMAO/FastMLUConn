...
bool Readerprotobuf::read_GenEvent(bool skip) {
    ...
    case HepMC3_pb::GenEventData::MEV: {
        m_evdata.momentum_unit = HepMC3::Units2::MEV;
        break;
    }
    case HepMC3_pb::GenEventData::GEV: {
        m_evdata.momentum_unit = HepMC3::Units2::GEV;
        break;
    }
    default: {
    ...
    case HepMC3_pb::GenEventData::MM: {
        m_evdata.length_unit = HepMC3::Units2::MM;
        break;
    }
    case HepMC3_pb::GenEventData::CM: {
        m_evdata.length_unit = HepMC3::Units2::CM;
        break;
    }
    default: {
