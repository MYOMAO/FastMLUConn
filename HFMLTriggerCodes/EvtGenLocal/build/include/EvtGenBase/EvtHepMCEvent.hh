...
typedef HepMC::FourVector2 FourVector2;
#define Units HepMC::Units
inline GenParticlePtr newGenParticlePtr(
    const FourVector2& mom = FourVector2( 0.0, 0.0, 0.0, 0.0 ), int pid = 0,
    int status = 0 )
{
    return new HepMC::GenParticle( mom, pid, status );
}
inline GenVertexPtr newGenVertexPtr(
    const FourVector2& pos = FourVector2( 0.0, 0.0, 0.0, 0.0 ) )
{
...
class EvtHepMCEvent {
  public:
    ...
    // Methods used to create GenParticles and FourVector2s of vertices.
    ...
    FourVector2 getVertexCoord( EvtParticle* theParticle );
